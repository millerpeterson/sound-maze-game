...
RecursiveBacktrack.method('generate', function(area, params) {
  this.area = area;
  this.startRoom = params['start'];
  this.visit(this.startRoom);
});

RecursiveBacktrack.method('visit', function(room) {
  var allNeightbors;
...
RecursiveBacktrack.method('wasVisited', function(room) {
  var target = room;
